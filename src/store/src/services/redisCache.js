...
export const cacheKeys = {
  ...
  poPending: (scope = "all") => buildKey("po", "pending", scope),
  ...
  gatePassPending: (scope = "all") => buildKey("gatepass", "pending", scope),
  gatePassReceived: (scope = "all") => buildKey("gatepass", "received", scope),
  ...
  returnableDetails: (scope = "all") => buildKey("returnable", "details", scope),
